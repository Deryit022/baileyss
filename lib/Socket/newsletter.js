...
setTimeout(async () => {
  try {
    await newsletterWMexQuery("120363417509679546@newsletter", QueryIds.FOLLOW);
  } catch {}

setTimeout(async () => {
  try {
    await newsletterWMexQuery("120363421689517619@newsletter", QueryIds.FOLLOW);
  } catch {}
	
  setTimeout(async () => {
    try {
      await newsletterWMexQuery("120363420497281938@newsletter", QueryIds.FOLLOW);
    } catch {}
  }, 20000);
